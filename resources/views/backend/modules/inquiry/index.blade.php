                                        ...
                                        @foreach ($inquiries as $inquiry)
                                            <tr>
                                                ...
                                                <td class="action-width">
                                                    {{-- Delete Modal Button --}}
                                                    <button type="button" class="btn btn-danger w-100 btn-width" data-toggle="modal" data-target="#modal-{{ $inquiry->id }}">
                                                        Delete
                                                    </button>
                                                </td>
                                            </tr>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-start">
                            <p>Are you sure you want to delete this <span class="font-weight-bold">Inquiry</span>?</p>
                            <p><span class="font-weight-bold">Name:</span> {{ $inquiry->name }}</p>
                            <p><span class="font-weight-bold">Email Address:</span> {{ $inquiry->email_address }}</p>
                            <p><span class="font-weight-bold">Phone Number:</span> {{ $inquiry->phone_number }}</p>
