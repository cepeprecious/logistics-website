    ...
    <section class="section-1 mt-5">
      <div class="container">
        <div class="d-flex flex-column flex-lg-row justify-content-around align-items-center border py-4 text-white" style="background-color: var(--color-2)">
          <p class="m-0 font-rubik"><i class="fa-solid fa-house me-2 color-1"></i> Door 8, FAB Bldg., F.S Dizon Rd., Bacaca, Barangay 19-B (Pob.) Davao City 8000</p>
          <p class="m-0 font-rubik"><i class="fa-solid fa-phone me-2 color-1"></i></i> +63 917 639 2247</p>
          <p class="m-0 font-rubik"><i class="fa-solid fa-envelope me-2 color-1"></i></i></i> marketing@rwebsolutions.com.ph</p>
        </div>
